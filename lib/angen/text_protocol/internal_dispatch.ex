defmodule Angen.TextProtocol.InternalDispatch do
  ...
  def lookup("Teiserver.Connections.Client:" <> _, :client_disconnected),
    do: InfoHandlers.ClientDestroyed

  # Lobby
  def lookup("Teiserver.Game.Lobby:" <> _, :match_start), do: InfoHandlers.MatchStart
  def lookup("Teiserver.Game.Lobby:" <> _, :match_end), do: InfoHandlers.MatchEnd
  ...
  def lookup("Teiserver.Game.Lobby:" <> _, :message_received),
    do: InfoHandlers.LobbyMessageReceived
