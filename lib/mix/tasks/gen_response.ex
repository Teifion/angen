defmodule Mix.Tasks.Angen.Gen.Response do
  ...
  def run([]) do
    raise "You need to provide a section and name"
  end
  ...
  defp do_module(template_data) do
    output_file =
      "#{@module_output_path}/#{template_data.lower_section}/#{template_data.lower_name}_response.ex"
  ...
  defp do_schema(template_data) do
    output_file =
      "#{@schema_output_path}/#{template_data.lower_section}/#{template_data.lower_name}_message.json"
