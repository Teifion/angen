defmodule Angen.TextProtocol.Account.ChangePasswordTest do
  ...
  test "unauth" do
    ...
    speak(socket, %{name: "account/change_password", command: %{current_password: "123", new_password: "456"}})
    msg = listen(socket)
  ...
  test "change" do
    ...
    speak(socket, %{name: "account/change_password", command: %{
    ...
    assert msg == %{
          ...
          "message" => %{
            ...
            "reason" => "There was an error changing your password: existing: Incorrect password"
          }
        }
    ...
    assert msg == %{
          ...
          "message" => %{
            "command" => "account/change_password",
            "reason" => "There was an error changing your password: password: Passwords must be at least 6 characters long"
          }
        }
