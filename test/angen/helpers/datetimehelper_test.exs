  ...
  describe "beginning and end of" do
    test "beginning_of_day" do
      ...
      |> Enum.each(fn {value, expected_result} ->
        ...
        assert result == expected_result, message: "DateTimeHelper.beginning_of_day(#{inspect(value)}) = #{inspect(result)} but expected #{inspect(expected_result)}"
      end)
    end
    ...
    test "beginning_of_quarter" do
      ...
      |> Enum.each(fn {value, expected_result} ->
        ...
        assert result == expected_result, message: "DateTimeHelper.beginning_of_quarter(#{inspect(value)}) = #{inspect(result)} but expected #{inspect(expected_result)}"
      end)
    end
    ...
    test "beginning_of_year" do
      ...
      |> Enum.each(fn {value, expected_result} ->
        ...
        assert result == expected_result, message: "DateTimeHelper.beginning_of_year(#{inspect(value)}) = #{inspect(result)} but expected #{inspect(expected_result)}"
      end)
    end
  end
end
